...
export const MENU: MenuItem[] = [
  ...
  {
    id: 2,
    label: "MENUITEMS.RESIDENTIAL.TEXT",
    icon: "ri-dashboard-2-line",
    subItems: [
      {
        id: 3,
        label: "MENUITEMS.RESIDENTIAL.LIST.APARTMENTS",
        link: "/home/residential/apartment",
        parentId: 2,
      },
      {
        id: 4,
        label: "MENUITEMS.RESIDENTIAL.LIST.VILLAS",
        link: "/home/residential/villa",
        parentId: 2,
      },
      {
        id: 5,
        label: "MENUITEMS.RESIDENTIAL.LIST.CASTLE",
        link: "/home/residential/castle",
        parentId: 2,
      },
      {
        id: 6,
        label: "MENUITEMS.RESIDENTIAL.LIST.CHALETS",
        link: "/home/residential/chalets",
        parentId: 2,
      },
    ],
  },
  ...
  {
    id: 7,
    label: "MENUITEMS.INDUSTRIAL.TEXT",
    icon: "ri-dashboard-2-line",
    subItems: [
      {
        id: 8,
        label: "MENUITEMS.INDUSTRIAL.LIST.FACTORIES",
        link: "/home/industrial/factory",
        parentId: 2,
      },
      {
        id: 9,
        label: "MENUITEMS.INDUSTRIAL.LIST.STORES",
        link: "/home/industrial/store",
        parentId: 2,
      },
    ],
  },
  ...
  {
    id: 10,
    label: "MENUITEMS.COMMERCIAL.TEXT",
    icon: "ri-dashboard-2-line",
    subItems: [
      {
        id: 11,
        label: "MENUITEMS.COMMERCIAL.LIST.ADMINISTRATIVE",
        link: "/home/commercial/administrative",
        parentId: 2,
      },
      {
        id: 12,
        label: "MENUITEMS.COMMERCIAL.LIST.CENTERS",
        link: "/home/commercial/shopping-center",
        parentId: 2,
      },
    ],
  },
  ...
  {
    id: 13,
    label: "MENUITEMS.AGRICULTURAL.TEXT",
    icon: "ri-dashboard-2-line",
    subItems: [
      {
        id: 14,
        label: "MENUITEMS.AGRICULTURAL.LIST.FARMS",
        link: "/home/argiculture/farm",
        parentId: 2,
      },
      {
        id: 15,
        label: "MENUITEMS.AGRICULTURAL.LIST.ORCHARDS",
        link: "/home/argiculture/orchads",
        parentId: 2,
      },
    ],
  },
  ...
  {
    id: 13,
    label: "MENUITEMS.LAND.TEXT",
    icon: "ri-dashboard-2-line",
    link: "/home/land/empty-land",
  },
  // {
  //   id: 2,
